...
export default {
  ...
  methods: {
    ...
    cardpay(){
      ...
      this.$ajax.post('/cxt/market/third/pay/card', _this.$qs.stringify(data),{
     ...
     cxtpay(){
      ...
      this.$ajax.post('/cxt/market/third/pay/cxt', _this.$qs.stringify(data),{
          headers: _this.Base.initAjaxHeader(1, data)
        }).then(res => {
           if(res.data.state==="000"){
              this.$router.push('/Market')
    ...
    fmpay(){
      ...
      this.$ajax.post('/cxt/market/third/pay/fm', _this.$qs.stringify(data),{
          headers: _this.Base.initAjaxHeader(1, data)
        }).then(res => {
           if(res.data.state==="000"){
              this.$router.push('/Market')
    ...
    scorepay(){
      ...
      this.$ajax.post('/cxt/market/third/pay/score', _this.$qs.stringify(data),{
          headers: _this.Base.initAjaxHeader(1, data)
        }).then(res => {
           if(res.data.state==="000"){
              this.$router.push('/Market')
