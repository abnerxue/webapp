  ...
  <div style=" overflow: hidden;">
    ...
    <van-row class="top">
      ...
      <van-col span="5">
        ...
        <p style="margin-top:0.15rem;color:#bcbcbc">手机联系人</p>
      </van-col>
      <van-col span="6">
        <van-icon class="iconfont" class-prefix='icon' name='icon_group' />
        <p style="margin-top:0.15rem;color:#bcbcbc">钉钉好友</p>
      </van-col>
      <van-col span="6">
        <van-icon class="iconfont" class-prefix='icon' name='icon_meeting' />
        <p style="margin-top:0.15rem;color:#bcbcbc">我的组群</p>
      </van-col>
      <van-col span="5">
        <van-icon class="iconfont" class-prefix='icon' name='icon_square' />
    ...
    <div v-for="(item,index) in pageData" :key="index">
      <div @click="gofgs(item.id,item.name)">
        ...
        <hr style="margin:0.2rem 5% 0.2rem 20%;width:75%" />
      </div>
    </div>
    ...
    <div>
      <p style="margin:0.2rem 0 0.3rem 0.3rem;font-size:0.35rem">常用联系人</p>
    </div>
