    ...
    <div>
      <div class="m-top">
        <van-row style="text-align:center">
          <van-col span="1"></van-col>
          <van-col span="22">{{this.$route.query.dptname}}</van-col>
          <van-col span="1"></van-col>
        </van-row>
      </div>
      <div class="top">
        <van-row style="text-align:center">
          ...
          <van-col span="16">{{this.$route.query.childname}}</van-col>
          <van-col span="4"></van-col>
        </van-row>
      </div>
      <div class="top">
      ...
      this.$ajax
        ...
        .then(res => {
          this.$router.push({
            path:'/childmember',
            query:{
              id: this.$route.query.childid,//子部门id
          coname: this.$route.query.coname,
          dptid:this.$route.query.dptid, //上级部门id
          dptname:this.$route.query.dptname,//上级部门名字
          name:this.$route.query.childname, //子部门名字
          pId: this.$route.query.pId //子公司id
            }
          })
        });
