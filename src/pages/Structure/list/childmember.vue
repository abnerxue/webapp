  ...
  <div class="m-bg">
    ...
    <van-row class="top">
      ...
      <van-col span="7" style="color:#00a2ff;font-size:0.3rem">
        <span @click="goa">{{this.$route.query.coname.slice(0,6)}}...</span>
      </van-col>
      <van-col span="2">
        <van-icon name="arrow" class="icon" />
      </van-col>
      <van-col span="5" style="color:#00a2ff;font-size:0.3rem;">
          <span @click="gob">{{this.$route.query.dptname.slice(0,6)}}</span>
      </van-col>
      <van-col span="2">
        <van-icon name="arrow" class="icon" />
      </van-col>
      <van-col span="5" style="font-size:0.3rem">{{this.$route.query.name.slice(0,6)}}</van-col>
    ...
    <van-row v-if="pagemember.length==0" style="margin-top:2.5rem;text-align:center">
      ...
      <van-col span="12">
        ...
        <p class="main-p2">点击下方添加员工</p>
      </van-col>
      <van-col span="6"></van-col>
    </van-row>
    <van-row style="position: fixed;bottom: 0;text-align:center;width:100%">
      <van-col span="12">
      ...
      <van-col span="12">
        <button class="btn" @click="editchilddept()">
        部门设置
      </button>
      </van-col>
    </van-row>
