...
<template>
  <div class="m-bg">
    ...
    <van-cell-group style="margin-top:1.2rem;">
      <van-field v-model="name" label="部门名称" style="font-size:0.3rem" :readonly="true" />
      <van-field v-model="uName" label="部门主管" style="font-size:0.3rem"  right-icon="arrow" @click="gochoose"/>
      <van-field v-model="dptname" label="上级部门" style="font-size:0.3rem" input-align="right" />
    </van-cell-group>
...
export default {
  ...
  methods: {
    ...
    top() {
      ...
      this.name = this.$route.query.name; //子部门名字
      this.dptname = this.$route.query.dptname; //上级部门名字
